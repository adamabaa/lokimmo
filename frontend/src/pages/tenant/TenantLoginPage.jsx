...
import { Home, ArrowRight, Building2, Key } from 'lucide-react'
      ...
      <div style={{ width: '100%', maxWidth: '420px', animation: 'fadeInScale 0.4s ease', position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <div style={{
            ...
            fontSize:     '0.78rem', color: '#3ecf8e',
            letterSpacing:'0.06em', textTransform: 'uppercase',
          }}>
            <Home size={13} /> Espace Locataire
          </div>
        </div>
          ...
          <form onSubmit={submit}>
            ...
            <button
              ...
              style={{
                ...
                background:     loading ? 'rgba(62,207,142,0.5)' : '#3ecf8e',
                color:          '#0a0c10',
                ...
                transition:     'all 0.2s',
                boxShadow:      loading ? 'none' : '0 4px 16px rgba(62,207,142,0.25)',
              }}
        ...
        <p style={{
          ...
          <Link to="/login" style={{ color: '#d4a853', textDecoration: 'none' }}>
            Connexion agence →
          </Link>
        </p>
      </div>
